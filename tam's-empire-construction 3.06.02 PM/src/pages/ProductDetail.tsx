...
import { MessageCircle, ArrowLeft, CheckCircle2, Settings, Target, Zap, Shield, Play } from 'lucide-react';
  ...
  if (!product) {
    return (
      <div className="pt-32 pb-24 text-center">
        ...
        <Link to="/produits" className="text-brand-gold font-bold flex items-center justify-center gap-2">
          <ArrowLeft size={20} />
          Retour aux produits
        </Link>
      </div>
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link to="/produits" className="inline-flex items-center gap-2 text-gray-500 hover:text-brand-gold transition-colors mb-8 group">
